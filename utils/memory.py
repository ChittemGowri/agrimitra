...
On Streamlit Cloud the filesystem resets between restarts, so memory
persists within a session (via Streamlit session_state) but not across
app restarts. For a production system you would swap this for a database.
"""
...
def _save_store(store: Dict[str, Any]) -> None:
    try:
        ...
        # On read-only filesystems (some cloud envs) just skip persistence
        pass
