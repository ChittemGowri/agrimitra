...
from config import APP_NAME, GEMINI_API_KEY, SUPPORTED_LANGUAGES, TRACKED_CROPS
...
with col_chat:
    ...
    if submit:
        if not GEMINI_API_KEY:
            st.error("Please set GEMINI_API_KEY in your .env file before running queries.")
